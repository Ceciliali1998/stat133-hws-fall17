...
_Here's the description of the R objects in `nba2017-player-statistics.csv`:_
...
_Here's the description of variables according to the glossary of basketball-reference:_
...
_Here is the [main source](www.basketball-reference.com) of the data_

_Here is a sample link for the data source of a given team (Godlen State Warriors)._
